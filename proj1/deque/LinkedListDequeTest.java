...
public class LinkedListDequeTest {
    ...
    public void getTest() {
        ...
        assertEquals(62, (double) lld1.get(62), 0.0);
        assertNull(lld1.get(101));

        assertEquals(22, (double) lld1.getRecursive(22), 0.0);
        assertEquals(0, (double) lld1.getRecursive(0), 0.0);
